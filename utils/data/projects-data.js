export const projectsData = [
    ...
    {
        id: 2,
        name: 'Raspberry Pi Ethernet IO Integration',
    ...
    {
        id: 3,
        name: 'Proxmox Web App Infrastructure',
        description: "A Proxmox-based virtual infrastructure designed to host a web application in three separate environments: Frontend Server, Backend Server, and Dev Server. This setup improves deployment organization, system stability, and development workflow by clearly separating production and testing workloads.",
        tools: ['Proxmox', 'Frontend Server', 'Backend Server,', 'Dev Server', 'Linux', 'MariaDB', 'Nginx', 'PM2', 'Apache2', 'PostgreSQL'],
        role: 'Software Engineer',
        code: '',
        demo: '',
    },
    {
        id: 4,
        name: 'Downtime Online / Check Sheet Online',
